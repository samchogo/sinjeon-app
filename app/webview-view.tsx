...
export default function WebviewViewScreen() {
  ...
  // removed duplicate older flutter shim
  ...
  const injectedFlutterExtendJs = `(() => { try { if (window.flutter_inappwebview && typeof window.flutter_inappwebview.callHandler==='function'){ var __orig=window.flutter_inappwebview.callHandler; window.flutter_inappwebview.callHandler=function(name){ try{ var n=String(name||''); if (n==='getReOrderInfo'){ try{ return Promise.resolve({ code:'0000', result:null }); } catch(e){ return Promise.resolve({ code:'9999', result:null }); } } }catch(_){ } try{ return __orig.apply(this, arguments); } catch(e){ return Promise.resolve(null); } }; } } catch(e){} })(); true;`;
